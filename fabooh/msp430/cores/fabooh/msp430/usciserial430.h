/*
 * usciserial430.h - cycle counting based RS232 Serial template for msp430
 *
 * Created: Nov-12-2012
...
struct serial_base_usci_t {
   ...
   */
  void begin(const uint32_t ignored=BAUD /* not used */) {
      ...
      P1SEL |= (TXPIN::pin_mask | RXPIN::pin_mask);   // launchpad uses P1.2=TXD P1.1=RXD
